            ...
            <ul class="nav navbar-nav">
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu dropdown-messages pull-right">
                        <li class="dropdown-title">4 Nuevos Mensajes</li>
                        <li class="unread message">
                            <a href="javascript:;" class="message"> <i class="pull-right" data-toggle="tooltip"
                                ...
                                <img src="http://lorempixel.com/output/abstract-q-c-45-45-9.jpg" class="img-responsive message-image"
                                     alt="icon">
                            ...
                            <a href="javascript:;" class="message">
                                <i class="pull-right" data-toggle="tooltip" data-placement="top"
                                   title="Mark as Read"><span class="pull-right ol livicon" data-n="adjust" data-s="10"
                                                              data-c="#287b0b"></span></i>
                                <img src="http://lorempixel.com/output/abstract-q-c-45-45-10.jpg" class="img-responsive message-image"
                                     alt="icon">

                                <div class="message-body">
                                    <strong>Sandra Jimenez</strong>
                                    <br>Vamos a revisarlo al fin... ?
                                    <br>
                        ...
                        <li class="unread message">
                            <a href="javascript:;" class="message">
                                ...
                                <img src="http://lorempixel.com/output/abstract-q-c-45-45-3.jpg" class="img-responsive message-image"
                                     alt="icon">

                                <div class="message-body">
                                    <strong>Giampaolo de Martiis</strong>
                                    <br>No se le olvide llamar!
                                    <br>
                        ...
                        <li class="unread message">
                            <a href="javascript:;" class="message">
                                ...
                                <img src="http://lorempixel.com/output/abstract-q-c-45-45-4.jpg" class="img-responsive message-image"
                                     alt="icon">
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class=" notifications dropdown-menu">
                        <li class="dropdown-title">Tienes 7 notificaciones</li>
                        <li>
                            ...
                            <ul class="menu">
                                <li>
                                    <i class="livicon danger" data-n="timer" data-s="20" data-c="white"
                                       data-hc="white"></i>
                                    <a href="#">ha pasado mucho tiempo</a>
                                ...
                                <li>
                                    <i class="livicon success" data-n="image" data-s="20" data-c="white"
                                       data-hc="white"></i>
                                    <a href="#">Camilo compartió tu foto</a>
                                    <small class="pull-right">
                                        <span class="livicon paddingright_10" data-n="timer" data-s="10"></span>
                                        Ayer
                                    </small>
                                ...
                                <li>
                                    <i class="livicon warning" data-n="thumbs-up" data-s="20" data-c="white"
                                       data-hc="white"></i>
                                    <a href="#">David le gusta tu foto</a>
                                    <small class="pull-right">
                                        <span class="livicon paddingright_10" data-n="timer" data-s="10"></span>
                                        2 Abril 2015
                                    </small>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="http://lorempixel.com/output/sports-q-c-35-35-5.jpg" width="35" class="img-circle img-responsive pull-left"
                             height="35" alt="riot">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header bg-light-blue">
                            <img src="http://lorempixel.com/output/sports-q-c-90-90-5.jpg" class="img-responsive img-circle"
                                 alt="User Image">
        ...
        <section class="sidebar purplebg">
            <div class="page-sidebar  sidebar-nav">
                ...
                <ul id="menu" class="page-sidebar-menu">
                    ...
                    <ul class="sub-menu">
                        <li {!! (Request::is(
                        'admin/form_builder') ? 'class="active"' : '') !!}>
                        <a href="{{ URL::to('admin/form_builder') }}">
                            <i class="fa fa-angle-double-right"></i>
                            Form Builder
                        </a>
                        ...
                        <li {!! (Request::is(
                        'admin/form_builder2') ? 'class="active"' : '') !!}>
                        <a href="{{ URL::to('admin/form_builder2') }}">
                            <i class="fa fa-angle-double-right"></i>
                            Form Builder 2
                        </a>
                        ...
                        <li {!! (Request::is(
                        'admin/buttonbuilder') ? 'class="active"' : '') !!}>
                        <a href="{{ URL::to('admin/buttonbuilder') }}">
                            <i class="fa fa-angle-double-right"></i>
                            Button Builder
                        </a>
                        ...
                        <li {!! (Request::is(
                        'admin/gridmanager') ? 'class="active"' : '') !!}>
                        <a href="{{ URL::to('admin/gridmanager') }}">
                            <i class="fa fa-angle-double-right"></i>
                            Page Builder
                        </a>
                    ...
                    <li {!! (Request::is(
                    'admin/form_examples') || Request::is('admin/editor') || Request::is('admin/form_layout') ||
                    Request::is('admin/validation') || Request::is('admin/formelements') ||
                    Request::is('admin/form_layouts') || Request::is('admin/formwizard') ||
                    Request::is('admin/accordionformwizard') ? 'class="active"' : '') !!}>
                    <a href="#">
                    ...
                    <ul class="sub-menu">
                        <li {!! (Request::is(
                        'admin/form_examples') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/formelements') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/form_layouts') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/accordionformwizard') ? 'class="active"' : '') !!}>
                    ...
                    <li {!! (Request::is(
                    'admin/animatedicons') || Request::is('admin/buttons') || Request::is('admin/advanced_buttons') ||
                    Request::is('admin/tabs_accordions') || Request::is('admin/panels') || Request::is('admin/icon') ||
                    Request::is('admin/color') || Request::is('admin/grid') || Request::is('admin/carousel') ||
                    Request::is('admin/advanced_modals') || Request::is('admin/tagsinput') ||
                    Request::is('admin/nestable') || Request::is('admin/toastr') || Request::is('admin/notifications')
                    || Request::is('admin/session_timeout') || Request::is('admin/portlet_draggable') ? 'class="active"'
                    : '') !!}>
                    <a href="#">
                    ...
                    <ul class="sub-menu">
                        <li {!! (Request::is(
                        'admin/animatedicons') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/advanced_buttons') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/tabs_accordions') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/advanced_modals') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/notifications') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/session_timeout') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/portlet_draggable') ? 'class="active"' : '') !!}>
                    ...
                    <li {!! (Request::is(
                    'admin/general') || Request::is('admin/pickers') || Request::is('admin/x-editable') ||
                    Request::is('admin/timeline') || Request::is('admin/transitions') || Request::is('admin/sliders') ||
                    Request::is('admin/knob') ? 'class="active"' : '') !!}>
                    <a href="#">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li {!! (Request::is(
                        'admin/transitions') ? 'class="active"' : '') !!}>
                    ...
                    <li {!! (Request::is(
                    'admin/simple_table') || Request::is('admin/responsive_tables') ||
                    Request::is('admin/advanced_tables') || Request::is('admin/editable_table') ? 'class="active"' : '')
                    !!}>
                    <a href="#">
                    ...
                    <ul class="sub-menu">
                        <li {!! (Request::is(
                        'admin/simple_table') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/advanced_tables') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/editable_table') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/responsive_tables') ? 'class="active"' : '') !!}>
                    ...
                    <li {!! (Request::is(
                    'admin/charts') || Request::is('admin/piecharts') || Request::is('admin/charts_animation') ||
                    Request::is('admin/jscharts') || Request::is('admin/sparklinecharts') ? 'class="active"' : '') !!}>
                    <a href="#">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li {!! (Request::is(
                        'admin/charts_animation') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/sparklinecharts') ? 'class="active"' : '') !!}>
                    ...
                    <li {!! (Request::is(
                    'admin/mail_box') || Request::is('admin/compose') || Request::is('admin/view_mail') ?
                    'class="active"' : '') !!}>
                    <a href="#">
                    ...
                    <li {!! (Request::is(
                    'admin/gallery') || Request::is('admin/masonry_gallery') || Request::is('admin/dropzone') ||
                    Request::is('admin/imagecropping') || Request::is('admin/multiple_upload') ||
                    Request::is('admin/imgmagnifier') ? 'class="active"' : '') !!}>
                    <a href="#">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li {!! (Request::is(
                        'admin/masonry_gallery') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/imagecropping') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/multiple_upload') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/imgmagnifier') ? 'class="active"' : '') !!}>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li {!! (Request::is(
                        'admin/advancedmaps') ? 'class="active"' : '') !!}>
                    ...
                    <li {!! (Request::is(
                    'admin/blog_list') || Request::is('admin/blog_details') || Request::is('admin/add_newblog') ?
                    'class="active"' : '') !!}>
                    <a href="#">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li {!! (Request::is(
                        'admin/blog_details') ? 'class="active"' : '') !!}>
                        ...
                        <li {!! (Request::is(
                        'admin/add_newblog') ? 'class="active"' : '') !!}>
                    ...
                    <li {!! (Request::is(
                    'admin/news') || Request::is('admin/news_item') ? 'class="active"' : '') !!}>
                    <a href="#">
                    ...
                    <li {!! (Request::is(
                    'admin/invoice') || Request::is('admin/blank') ? 'class="active"' : '') !!}>
                    <a href="#">
